...
namespace TerminalEden.Simulation
{
    ...
    public class WildfireSimulation : SingletonBehaviour<WildfireSimulation>
    {
        ...
        public RenderTextureEvent onSelectionTextureCreated = new RenderTextureEvent();
        ...
        public void HighlightCells(Vector2 uv)
        {
            ...
            selectionMat.SetVectorArray("_SelectedCells", selection);
            selectionMat.SetFloat("_SelectedCellsSize", selection.Count);
            Graphics.Blit(selectionTexture, selectionTexture, selectionMat);
        }
        ...
        void InitSimulation()
        {
            ...
            // Create Selection Render Texture
            selectionTexture = new RenderTexture(textureResolution, textureResolution, 1);
            selectionTexture.filterMode = FilterMode.Point;
            selectionTexture.Create();
            onSelectionTextureCreated.Invoke(selectionTexture);
            ...
            selectionMat.SetInt("textureSize", textureResolution);
        }
        ...
        public void WriteToSimulation(Texture2D newInfo)
        {
            Graphics.Blit(newInfo, sim[currentState]);
        }
